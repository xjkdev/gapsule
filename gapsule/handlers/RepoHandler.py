...
class CodeListHandler(BaseHandler):
    ...
    def get(self, username, projectname):
        ...
        code_dict = {
            "foider" : get_specified_path() #goto 参数username, projectname,分支为默认master
        }                                   #文件路径为/
...
class FolderListHandler(BaseHandler):
    ...
    def get(self, username, projectname, branch, restpath):
        folder_dict = {
            "foider" : get_specified_path() #goto 参数username, projectname,branch, restpath
        }
...
class FileContentHandler(BaseHandler):
    ...
    def get(self, username, projectname, branch, restpath):
        file_dict = {
            "file" : get_file_content(restpath) #goto 参数username, projectname,branch, restpath
        }
